...
# python -m grpc_tools.protoc -I./proto --python_out=src/browser_rpc/proto_gen --grpc_python_out=src/browser_rpc/proto_gen ./proto/spider.proto
try:
    from browser_rpc.proto_gen import spider_pb2
    from browser_rpc.proto_gen import spider_pb2_grpc
except ImportError:
    # 如果 proto 文件还未编译，提供占位符
    print("警告: proto 文件尚未编译，请运行: python -m grpc_tools.protoc -I./proto --python_out=src/browser_rpc/proto_gen --grpc_python_out=src/browser_rpc/proto_gen ./proto/spider.proto")
    spider_pb2 = None
    spider_pb2_grpc = None

from browser_rpc.core.cdp_client import BrowserPool
